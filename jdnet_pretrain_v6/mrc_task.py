...
@register_task('mrc_task')
class MRCTask(FairseqTask):
    """
...
#         pdb.set_trace()
    ...
    def build_generator(self, args):
        if getattr(args, 'score_reference', False):
            ...
            from mrc_generator import MRCGenerator, MRCGeneratorWithAlignment
            if getattr(args, 'print_alignment', False):
                seq_gen_cls = MRCGeneratorWithAlignment
            else:
                seq_gen_cls = MRCGenerator
            return seq_gen_cls(
