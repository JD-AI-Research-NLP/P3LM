...
@register_model('P2DeNetClassification')
class NgramTransformerProphetModel(FairseqEncoderDecoderModel):
    ...
    def build_model(cls, args, task):
        ...
        model = NgramTransformerProphetModel(args, encoder, decoder, mlmDecoder)
...
#         pdb.set_trace()
        ...
        return NgramTransformerProphetModel(args, encoder, decoder, mlmDecoder)
...
class TransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        self.outputs = nn.Linear(embed_dim, 94)
...
#         start_logits, end_logits = torch.chunk(logits, 2, -1)
...
@register_model_architecture('P2DeNetClassification', 'P2DeNetClassification')
...
@register_model_architecture('P2DeNetClassification', 'P2DeNetClassification_base')
...
@register_model_architecture('P2DeNetClassification', 'P2DeNetClassification_middle')
...
@register_model_architecture('P2DeNetClassification', 'P2DeNetClassification_large')
