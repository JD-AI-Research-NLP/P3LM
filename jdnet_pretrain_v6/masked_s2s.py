...
#     MLMLanguagePairDataset,
#     JDNetLanguageTripletDataset,
    BertDictionary
)
from jdnet_dataset import (
    MLMLanguagePairDataset,
    JDNetLanguageTripletDataset
)
...
class MaskedS2STask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--data-mask-type', default='MASS', help='MASS or MLM')
    ...
    def __init__(self, args, dictionary):
        ...
        self.data_mask_type = getattr(args, 'data_mask_type', 'MASS')
...
#         pdb.set_trace()
    ...
    def build_s2s_dataset(self, dataset):
        ...
        elif self.data_mask_type=='JDNet':
            s2s_dataset = JDNetLanguageTripletDataset(
                dataset, dataset.sizes, self.source_dictionary,
                shuffle=True, mask_prob=self.args.mask_s2s_prob,
                pred_probs=pred_probs,
                block_size=self.args.block_size,
