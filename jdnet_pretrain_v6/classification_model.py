...
@register_model('jdnet_classification')
class JDNetClassificationModel(FairseqEncoderDecoderModel):
    """
    Args:
...
#         mlmDecoder = MLMDecoder(args, tgt_dict, mlmDecoder_embed_tokens)
        ...
        model = JDNetClassificationModel(args, encoder, classifier)
...
#                 )            
        ...
        return JDNetClassificationModel(args, encoder, classifier)
...
@register_model_architecture('jdnet_classification', 'jdnet_classification')
...
@register_model_architecture('jdnet_classification', 'jdnet_classification_base')
...
@register_model_architecture('jdnet_classification', 'jdnet_classification_middle')
...
@register_model_architecture('jdnet_classification', 'jdnet_classification_large')
