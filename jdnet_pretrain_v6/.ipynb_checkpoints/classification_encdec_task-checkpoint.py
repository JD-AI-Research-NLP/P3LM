...
@register_task('classification_encdec_task')
class ClassificationEncDecTask(FairseqTask):
    """
...
#         assert src_dict.unk() == tgt_dict.unk()
    ...
    def build_generator(self, args):
        if getattr(args, 'score_reference', False):
            ...
            from classification_encdec_generator import ClassificationGenerator, ClassificationGeneratorWithAlignment
            if getattr(args, 'print_alignment', False):
                seq_gen_cls = ClassificationGeneratorWithAlignment
            else:
                seq_gen_cls = ClassificationGenerator
            return seq_gen_cls(
