...
@register_task('mrc_enc_task')
class MrcEncTask(FairseqTask):
    """
...
#         assert src_dict.unk() == tgt_dict.unk()
    ...
    def build_generator(self, args):
        if getattr(args, 'score_reference', False):
            ...
            from mrc_enc_generator import MRCEncGenerator, MRCEncGeneratorWithAlignment
            if getattr(args, 'print_alignment', False):
                seq_gen_cls = MRCEncGeneratorWithAlignment
            else:
                seq_gen_cls = MRCEncGenerator
            return seq_gen_cls(
