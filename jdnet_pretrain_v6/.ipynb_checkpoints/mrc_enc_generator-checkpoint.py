...
#         pdb.set_trace()
        ...
        start_logits = classification_out[0]['start_end_logits'][0]
        end_logits = classification_out[0]['start_end_logits'][1]
#         answerable_logit = encoder_outs[0]['answerable_logit']
...
#         return (start_logits, end_logits, answerable_logit)
...
class MRCEncGeneratorWithAlignment(MRCEncGenerator):
